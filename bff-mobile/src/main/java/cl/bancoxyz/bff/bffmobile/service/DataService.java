...
import cl.bancoxyz.bff.bffmobile.dto.*; import cl.bancoxyz.bff.bffmobile.client.LegacyApiClient; import org.springframework.stereotype.Service; import java.util.*;
@Service public class DataService {
  private final LegacyApiClient legacy; public DataService(LegacyApiClient l){this.legacy=l;}
